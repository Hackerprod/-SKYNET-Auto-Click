...
namespace SKYNET.Controls
{
    public class SKYNET_Button : Control
    {
        ...
        [Category("SKYNET")]
        public ImgAlign ImageAlignment
        {
            get
            {
                return _ImageAlign;
        ...
        public SKYNET_Button()
        {
            ...
            _ImageY = 0;
            _ImageIcon = null;
            BackColor = Color.FromArgb(49, 60, 72);
